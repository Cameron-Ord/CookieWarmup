...
function add_to_counter(details_counter){
counter +=1;
let counter_display = document.querySelector(`#counter_display`);
counter_display[`innerHTML`] = counter;

}

let counter_button = document.querySelector(`#add_button`);
counter_button.addEventListener(`click`, add_to_counter);
